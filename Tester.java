...
public class Tester {
	...
	public static void task3_3() {
		...
		System.out.println(
				"Test 3 - element not in table, your result: " + table.search((long) 100000) + ", Should be: null ");
		System.out.println("\nChecking deletion:");
		table.delete((long) -5);
		table.delete((long) 100);
		System.out.println(
				"Test 4 - element that shouldnt exist, your result: " + table.search((long) -5) + ", Should be: null ");
		System.out.println("Test 5 - element that shouldnt exist, your result: " + table.search((long) 100)
				+ ", Should be: null ");
		...
		if (counter2 != 0) {
			...
			System.out.println(
					"1. Could be the use of '==' to compare two 'Long' types: instead, try using 'long.equals(long)' option.");
			System.out.println(
					"2. Could be a problem with the rehash function - make sure you send the correct k to the new 'pick hash' function you build.");
			System.out.println("!!!------------------------------------------------------------------------------!!!");
	...
	public static void task3_7() {
		...
		System.out.println(
				"\nExample results from my test - but it could be pretty different based on your computer and algorithms.");
		System.out.println(
				"[224.9244666890469, 115.8369107444406, 156.68574044403755, 70.20131633826027, 195.5558437793257]\n"
	...
	public static void task3_8() {
		...
		System.out.println(
				"\nExample results from my test - but it could be pretty different based on your computer and algorithms.");
		System.out.println(
				"[158.27204199346903, 87.44277837683872, 104.57007705806058, 141.71795367384516, 154.7634488178163]\n"
	...
	public static void task4_1() {
		...
		System.out.println(struc.rank(1) + " " + struc.select(5));
		System.out.println(struc.range(3, 7));
		System.out.println(struc.delete(0));
		System.out.println(struc.contains(0) + " " + struc.contains(7));
	...
	public static void task4_5() {
		...
		System.out.println("Test 1 - Rank of existing element: " + struc.rank(2) + ", Should be: 3 ");
